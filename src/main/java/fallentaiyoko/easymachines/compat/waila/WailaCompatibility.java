package fallentaiyoko.easymachines.compat.waila;
...
public class WailaCompatibility implements IWailaDataProvider {
    ...
    public static void register() {
        ...
        registered = true;
         FMLInterModComms.sendMessage("Waila", "register", "fallentaiyoko.easymachines.compat.waila.WailaCompatibility.load");
